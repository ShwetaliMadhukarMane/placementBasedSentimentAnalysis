...
<form action="Placesaction.php" method="post" name="form" id="form" enctype="multipart/form-data">
				...
				<div class="row">
                  ...
                  <div class="col-md-6 margin-bottom-15">
                    ...
                    <input type="text" name="ucontent1"  value="<?php echo $row['PTitle']; ?>" class="form-control" id="lastName" Placeholder="Title">        
                  </div>
                </div>
				...
				<div class="row">
                  <div class="col-md-6 margin-bottom-15">
                    ...
                    <textarea name="ucontent2" class="form-control" id="firstName"><?php echo $row['Pinfo']; ?>  </textarea>
                  </div>
                </div>
...
mysql_query("INSERT INTO places(PTitle,Pinfo,Pdate,Pfile,Ptype,Latitude,Longitude) VALUES('$content','$content1','$RD','$h','$content2','$content3','$content4')");
...
mysql_query("update places set PTitle='$ucontent1', Pinfo='$ucontent2',Pfile='$h',Ptype='$ucontent3',Latitude='$ucontent4',Longitude='$ucontent5' where PID=$ucontent");
...
<a href="#" class="Edit" id="<?php echo $row['PID']; ?>">[ Update ]</a>
</TD>
</TR>
<?php
}
