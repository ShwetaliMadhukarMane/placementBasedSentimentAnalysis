...
$mess.=nullvalid($content1,"Enter Places Title,");
$mess.=nullvalid($content2,"Enter Places Info,");
...
$mess.=OnlyNumbervalid($ucontent,"Enter valid Places ID,");
$mess.=nullvalid($ucontent1,"Enter Places Title,");
$mess.=nullvalid($ucontent2,"Enter Places Info,");
