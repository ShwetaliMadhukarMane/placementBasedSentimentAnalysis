...
{
$id=$_POST['id'];
$delete = "DELETE FROM Healthcare WHERE ID='$id'";
mysql_query( $delete);
}
?>
...
{
$id=$_POST['ide'];
$select_table = "select * from Healthcare where ID=".$id;
...
<div id="cp_contact_form">
<form action="Healthcareaction.php" method="post" name="form" id="form" enctype="multipart/form-data">
			...
			<div class="row">
                  <div class="col-md-6 margin-bottom-15">
					...
					<option value="Dermitalogist">Dermitalogist</option>
...
mysql_query("INSERT INTO Healthcare(Title,Address,datesave,Imgfile,type,Latitude,Longitude) VALUES('$content','$content1','$RD','$h','$content2','$content3','$content4')");
...
mysql_query("update Healthcare set Title='$ucontent1', Address='$ucontent2',Imgfile='$h',type='$ucontent3',Latitude='$ucontent4',Longitude='$ucontent5' where ID=$ucontent");
...
<h4 class="margin-bottom-15">All Health Care</h4>
...
<?PHP
					$per_page = 5; 
					$select_table = "select * from Healthcare";
					$fetch= mysql_query($select_table);
