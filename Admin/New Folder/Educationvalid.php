...
$mess.=nullvalid($content1,"Enter Education Title,");
$mess.=nullvalid($content2,"Enter Education Address,");
...
$mess.=OnlyNumbervalid($ucontent,"Enter valid Education ID,");
$mess.=nullvalid($ucontent1,"Enter Education Title,");
$mess.=nullvalid($ucontent2,"Enter Education Address,");
