...
{
$id=$_POST['id'];
$delete = "DELETE FROM entertainment WHERE ID='$id'";
mysql_query( $delete);
}
?>
...
{
$id=$_POST['ide'];
$select_table = "select * from entertainment where ID=".$id;
...
<div id="cp_contact_form">
<form action="Entertainmentaction.php" method="post" name="form" id="form" enctype="multipart/form-data">
...
mysql_query("INSERT INTO entertainment(Title,Address,datesave,Imgfile,type,Latitude,Longitude) VALUES('$content','$content1','$RD','$h','$content2','$content3','$content4')");
...
mysql_query("update entertainment set Title='$ucontent1', Address='$ucontent2',Imgfile='$h',type='$ucontent3',Latitude='$ucontent4',Longitude='$ucontent5' where ID=$ucontent");
...
<h4 class="margin-bottom-15">All Entertainment Location</h4>
...
<?PHP
					$per_page = 5; 
					$select_table = "select * from entertainment";
					$fetch= mysql_query($select_table);
