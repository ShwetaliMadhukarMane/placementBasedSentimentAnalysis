...
{
$id=$_POST['ide'];
$select_table = "select * from Hotels where ID=".$id;
...
<div id="cp_contact_form">
<form action="Hotelsaction.php" method="post" name="form" id="form" enctype="multipart/form-data">
...
mysql_query("INSERT INTO Hotels(Title,Address,datesave,Imgfile,Latitude,Longitude) VALUES('$content','$content1','$RD','$h','$content3','$content4')");
...
mysql_query("update Hotels set Title='$ucontent1', Address='$ucontent2',Imgfile='$h',Latitude='$ucontent4',Longitude='$ucontent5' where ID=$ucontent");
...
<h4 class="margin-bottom-15">All Hotels</h4>
...
<?PHP
					$per_page = 5; 
					$select_table = "select * from Hotels";
					$fetch= mysql_query($select_table);
