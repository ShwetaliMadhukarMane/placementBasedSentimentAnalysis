...
$mess.=nullvalid($content1,"Enter News Title,");
$mess.=nullvalid($content2,"Enter News Info,");
...
$mess.=OnlyNumbervalid($ucontent,"Enter valid Teacher ID,");
$mess.=nullvalid($ucontent1,"Enter News Title,");
$mess.=nullvalid($ucontent2,"Enter News Info,");
