...
$mess.=nullvalid($content1,"Enter Hotels Title,");
$mess.=nullvalid($content2,"Enter Hotels Address,");
...
$mess.=OnlyNumbervalid($ucontent,"Enter valid Hotels ID,");
$mess.=nullvalid($ucontent1,"Enter Hotels Title,");
$mess.=nullvalid($ucontent2,"Enter Hotels Address,");
